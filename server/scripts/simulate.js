...
const SEARCH_BANKS = {
  finance: [
    { t: '订阅制产品的定价误区：为什么低价套餐反而拉低留存', a: '产品笔记君', ut: 'product-notes', v: 3241, c: 217, s: '做订阅制 SaaS 第三年，我把定价从 9.9 美元调到 19 美元，流失率反而下降了。低价吸引来的用户留存意愿低、客服成本高，算总账是亏的。定价的本质是筛选，不是促销。' },
  ...
  china: [
    { t: '回到成都远程办公一年，我的账本和生活都变了', a: '蓉城远程客', ut: 'chengdu-remote', v: 4123, c: 389, s: '离开上海前月薪两万二、房租五千五；回成都后远程拿八折工资、房租一千八，每天多出两小时。真正的变化是生活半径和心理状态，以及重新计算的职业安全感。' },
  ...
  life: [
    { t: '连续加班三个月后，我用睡眠监测数据说服了老板', a: '睡眠自救指南', ut: 'sleep-rescue', v: 5231, c: 467, s: '把三个月的深睡时长、静息心率和心率变异性整理成一张图发给主管，比任何抱怨都有说服力。数据证明长期睡眠不足的团队，产出质量在以可测量的方式下降。' },
  ...
  world: [
    { t: '硅谷科技公司的 AI 发布会为什么越来越像宗教仪式', a: '湾区科技观察', ut: 'bay-area-tech', v: 2876, c: 342, s: '从舞台设计到叙事结构，硅谷的发布会正在模板化：先讲使命，再讲数字，最后讲价格。观众要的不是参数，而是一个可以转述的故事。理解这套叙事，才能看懂它的影响力。' },
  ...
  culture: [
    { t: '信息过载时代，为什么重读比新书更重要', a: '重读俱乐部', ut: 'reread-club', v: 4521, c: 378, s: '一年读五十本新书，不如把五本好书重读三遍。重读时你会带着这一年的问题回去，看到的全是第一遍看不见的东西。经典的价值在于它能承受反复提问。' },
  ...
  tech: [
    { t: '大模型 Agent 落地半年：从 Demo 到生产的距离', a: 'Agent 工程笔记', ut: 'agent-eng-notes', v: 3654, c: 312, s: 'Demo 里 Agent 什么都能做，生产环境里第一件事是砍掉八成的工具调用。可控的工作流编排比自由发挥的智能更有商业价值。稳定性是 Agent 产品的第一道门槛。' },
