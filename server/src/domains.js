...
export const DOMAINS = [
  {
    ...
    keywords: ['科技', 'AI', '产品', 'Agent', '工具', '模型', '互联网', '开发', '设计', '编程',
  ...
  },
  {
    ...
    keywords: ['财经', '商业', '成本', '预算', '订阅', '付费', '收入', '变现', '股票', '基金', '降本',
  ...
  },
  {
    id: 'china', name: '国内',
    angle: '工作变化如何改居住和在场',
    keywords: ['国内', '社会', '城市', '居住', '房租', '县城', '回流', '远程', '编制', '就业', '杭州', '成都',
      '落户', '买房', '一线', '二线', '育儿', '北漂'],
  ...
  },
  {
    id: 'life', name: '生活',
    angle: '工作闭环征走了哪一块身体',
    keywords: ['生活', '睡眠', '加班', '专注', '通勤', '健康', '焦虑', '休息', '晚上',
